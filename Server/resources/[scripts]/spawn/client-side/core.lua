...
function SendNotification()
	if NotifyWeather then
		TriggerEvent("Notify",ServerName,WeatherWarning.." <b>"..WeathersType(GlobalState["Weather"]).."</b>.","weather",10000,"bottom-center",false,false,true)
	end

	if NotifyLogin then
		TriggerEvent("Notify",ServerName,LoginWarning,"bed",30000,"bottom-center",false,false,false)
	end
end