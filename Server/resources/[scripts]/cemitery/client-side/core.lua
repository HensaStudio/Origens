	...
	if not Peds then
		...
		if LoadModel(List[Hash]) then
			...
			if not Waypoint then
				exports["waypoints"]:AddWaypoint(vec3(Locates[Number][Selected].x,Locates[Number][Selected].y,Locates[Number][Selected].z),{ label = "Túmulo", color = Theme["main"], autoRemove = true })
